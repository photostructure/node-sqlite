...
Native SQLite for Node.js 20+. Drop-in replacement for `node:sqlite`. Synced with Node.js v26.0.0 for the latest features including native `Symbol.dispose` resource management.
...
- 100% compatible with Node.js v26.0.0 built-in `node:sqlite` module\*
