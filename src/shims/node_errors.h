...
inline void THROW_ERR_INVALID_STATE(Napi::Env env, const char* message = nullptr) {
  const char* msg = message ? message : "Invalid state";
  Napi::Error::New(env, msg).ThrowAsJavaScriptException();
}

inline void THROW_ERR_INVALID_ARG_TYPE(Napi::Env env, const char* message = nullptr) {
  const char* msg = message ? message : "Invalid argument type";
  Napi::TypeError::New(env, msg).ThrowAsJavaScriptException();
}

inline void THROW_ERR_OUT_OF_RANGE(Napi::Env env, const char* message = nullptr) {
  const char* msg = message ? message : "Value out of range";
  Napi::RangeError::New(env, msg).ThrowAsJavaScriptException();
}

inline void THROW_ERR_INVALID_ARG_VALUE(Napi::Env env, const char* message = nullptr) {
  const char* msg = message ? message : "Invalid argument value";
  Napi::Error::New(env, msg).ThrowAsJavaScriptException();
}

inline void THROW_ERR_SQLITE_ERROR(Napi::Env env, const char* message = nullptr) {
...
inline void THROW_ERR_INVALID_URL_SCHEME(Napi::Env env, const char* scheme = nullptr) {
...
inline void THROW_ERR_LOAD_SQLITE_EXTENSION(Napi::Env env, const char* message = nullptr) {
